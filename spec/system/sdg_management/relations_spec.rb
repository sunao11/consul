...
describe "SDG Relations", :js do
  ...
  describe "Index" do
    ...
    scenario "list records pending to revise for the current model by default" do
      create(:debate, title: "I'm a debate")
      create(:sdg_revision, relatable: create(:debate, title: "I'm a revised debate"))

      visit sdg_management_debates_path

      expect(page).to have_text "I'm a debate"
      expect(page).not_to have_text "I'm a revised debate"
    ...
    scenario "list all records for the current model when user clicks on 'all' tab" do
      ...
      expect(page).to have_text "I'm a debate"
      expect(page).to have_text "I'm a revised debate"
    end

    scenario "list revised records for the current model when user clicks on 'revised' tab" do
      create(:debate, title: "I'm a debate")
      create(:sdg_revision, relatable: create(:debate, title: "I'm a revised debate"))
